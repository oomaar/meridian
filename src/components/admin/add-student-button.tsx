...
export function AddStudentButton({ onAdd }: { onAdd?: (row: AdminStudentRow) => void } = {}) {
    ...
    <>
      ...
      {open && (
        <>
          ...
          <div className="m-sheet" role="dialog" aria-modal="true" aria-label="Add student">
            ...
            <form onSubmit={handleSubmit} className="m-sheet__body">
              ...
              <label className="m-field">
                ...
                <input className="m-field__input m-mono" placeholder="firstname.lastname@aldridge.edu"
                  value={form.email}
                  onChange={(e) => { setEmailTouched(true); set("email", e.target.value); }}
                  required />
              </label>

              <label className="m-field">
                <span className="m-field__label">Program</span>
                <select className="m-field__input m-field__select" value={form.program}
              ...
              <div className="m-fields-2">
                <label className="m-field">
                  ...
                  <select className="m-field__input m-field__select" value={form.standing}
                    onChange={(e) => set("standing", e.target.value)}>
                    {["Freshman","Sophomore","Junior","Senior","Graduate"].map((s) => (
            ...
            <div className="m-sheet__foot">
              ...
              <button className="m-btn m-btn--primary" disabled={save !== "idle"} onClick={handleSubmit}>
