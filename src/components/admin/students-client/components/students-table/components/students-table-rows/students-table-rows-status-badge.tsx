...
type StudentsTableRowsStatusBadgeStatusBadgeProps = { status: StudentStatus };

export function StudentsTableRowsStatusBadge({
  status,
}: StudentsTableRowsStatusBadgeStatusBadgeProps) {
